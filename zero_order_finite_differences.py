...
def text_generation_train(net, train_dataloader, test_dataloader):
    ...
    for epoch in range(1, epochs+1):
        ...
        for batch_index, batch in enumerate(train_dataloader):
            ...
            for perturbation_index in range(perturbation_count): 
                ...
                with torch.no_grad(), record_function("## forward 1 ##"):
            ...
            if iteration % accumulation_steps == 0:
                ...
                wandb.log({
                    ...
                    "random_gradient": dict(net.named_parameters())[key_to_track].grad[0][0] if key_to_track != '' and dict(net.named_parameters())[key_to_track].grad is not None else 0,
                    "perturbations_mean": {
                    ...
                    "random_perturbation": dict(tangents.items())[key_to_track][0][0] if key_to_track != '' else 0,
                })
                del tangents
                ...
                with record_function("## optimizer ##"):
                    ...
                    if optimizer_name =='adamw' or optimizer_name =='adam':
                        wandb.log({
                            ...
                            "random_parameter_avg_sq": optimizer.state[dict(net.named_parameters())[key_to_track]]['exp_avg_sq'][0][0] if key_to_track != '' else 0,
                            "random_parameter_avg": optimizer.state[dict(net.named_parameters())[key_to_track]]['exp_avg'][0][0] if key_to_track != '' else 0,
                        })
            ...
            wandb.log({
                ...
                "random_parameter": dict(net.named_parameters())[key_to_track][0][0] if key_to_track != '' else 0,
            })
    ...
    for epoch in range(1, epochs+1):
        ...
        for batch_index, batch in enumerate(train_dataloader):
            ...
            for perturbation_index in range(perturbation_count): 
                ...
                if iteration == 0:
                    gradients, tangents, loss, projected_gradient = generate_gradients_for_zero_order_calibration_phase(
                        net, trainable_layer_names, params, batch_dict, 
                        perturbation_step_size, perturbation_step_size, projected_gradient_range
                    )
...
def text_classification_train(net, train_dataloader, test_dataloader):
    ...
    for epoch in range(1, epochs+1):
        ...
        for batch_index, batch in enumerate(train_dataloader):
            ...
            # print('Activations. Memory allocated: ', end_memory_allocated - start_memory_allocated, flush=True)    
            # print('Activations. Memory reserved: ', end_memory_reserved - start_memory_reserved, flush=True)    
            # sys.exit(0)
            ...
            if iteration % accumulation_steps == 0:
                ...
                # print('Gradients and States. Memory allocated: ', end_memory_allocated - start_memory_allocated, flush=True)    
                # print('Gradients and States. Memory reserved: ', end_memory_reserved - start_memory_reserved, flush=True)    
                # sys.exit(0)
            ...
            wandb.log({
                ...
                "random_parameter": [key_to_track][0][0] if key_to_track != '' else 0,
            })
...
def vqa_train(net, train_dataloader, test_dataloader,):
    if optimizer_name =='adamw': 
        optimizer = AdamW(net.parameters(), lr=lr)
    elif optimizer_name =='adam': 
        optimizer = Adam(net.parameters(), lr=lr)
                ...
                with record_function("## optimizer ##"):
                    ...
                    if optimizer_name =='adamw' or optimizer_name =='adam':
                        wandb.log({
                            ...
                            "random_parameter_avg_sq": optimizer.state[params[key_to_track]]['exp_avg_sq'][0][0] if key_to_track != '' else 0,
                            "random_parameter_avg": optimizer.state[params[key_to_track]]['exp_avg'][0][0] if key_to_track != '' else 0,
                        })
...
if __name__ == "__main__":
    ...
    # print('Model Weights. Memory allocated: ', end_memory_allocated - start_memory_allocated, flush=True)    
    # print('Model Weights. Memory reserved: ', end_memory_reserved - start_memory_reserved, flush=True)    
    # sys.exit(0)
    
    wandb.init(
        project='ZeroOrderFiniteDifferences'+dataset,
    ...
    if dataset == 'agnews':
        ...
        if calibrated == False:
            text_classification_train(net, train_dataloader, test_dataloader)
        else:
        ...
        if calibrated == False:
            text_generation_train(net, train_dataloader, test_dataloader)
        else:
        ...
        if calibrated == False:
            vqa_train(net, train_dataloader, test_dataloader,)
        else:
